...
(optional if you like Vim editor over emacs/nano) >sudo apt-get install vim
`sudo apt-get update
...
set up pi cam to be used with Motion on boot
`vim /etc/rc.local      (emacs/nano optional)`
add line to file:
